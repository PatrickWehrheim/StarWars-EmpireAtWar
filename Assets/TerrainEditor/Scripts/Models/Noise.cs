...
public class Noise
{
    ...
    public static readonly int[] Source = {
    ...
    public const double G22 = G2 * 2.0 - 1;

    public const double F3 = 1.0 / 3.0;
    public const double G3 = 1.0 / 6.0;

    public const double F4 = (Sqrt5 - 1.0) / 4.0;
    public const double G4 = (5.0 - Sqrt5) / 20.0;
    public const double G42 = G4 * 2.0;
    public const double G43 = G4 * 3.0;
    public const double G44 = G4 * 4.0 - 1.0;
